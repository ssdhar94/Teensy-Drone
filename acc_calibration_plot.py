...
A = np.array([[1.000312, -0.000326, 0.002377],  # 'A^-1' matrix from Magneto
              [-0.000326, 1.001031, -0.000630],
              [0.002377, -0.000630, 0.993011]])
# 'Combined bias (b)' vector from Magneto
b = np.array([-0.003354, -0.006880, -0.030498])

# Read raw data and apply calibration
rawData = np.genfromtxt('acc_cal_data2.txt',
